...
x_pde, t_pde = master_func_learn_ivp_pde(simulate_only = {"simulate_only": True, "xStart": xStart}, T = T, A = A_pde, b = b_pde)
...
plt.savefig(f"trajectory_data_ode_and_pde_T_{T}_A_{A_ode},_b_{b_ode}_xStart_{xStart}.png", dpi=5*96)
plt.close()
system(f"open trajectory_data_ode_and_pde_T_{T}_A_{A_ode},_b_{b_ode}_xStart_{xStart}.png")
