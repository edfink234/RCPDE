...
df = {}
try:
    with open("../dataFiles/ICs_x0_loss_time.txt", 'r') as f:
        reader = csv.reader(f)
        for row in reader:
    ...
    with open("../dataFiles/ICs_x0_loss_time.txt", 'w') as f:
...
def newton_method():
    ...
    while criterion():
        ...
        if new_loss < best_loss:
            ...
            # Write to CSV
            with open('../dataFiles/ICs_x0_loss_time.txt', 'w', newline='') as file:
