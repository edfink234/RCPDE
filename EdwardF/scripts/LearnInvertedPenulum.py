...
#            xi_0 = xi(0)
    ...
    def brute_force(fine = False, coolingRate = 0.99, anneal = False, initial_temp = 1):
        ...
        while criterion():
            ...
            print(f"Curr Loss = {new_loss:.6f}, Curr Time = {new_time:.6f}, Curr Temp = {temperature:.6f}")
