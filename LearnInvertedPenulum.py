...
model_path = f"xi_model_IC_{flt_to_str(closest_x)}_.pth"
new_model_path = f"xi_model_IC_{flt_to_str(x_start)}_.pth"
print(model_path)
...
try:
    while True:
        ...
        if loss_value.item() < best_loss:
            ...
            # Write to CSV
            with open('ICs.txt', 'w', newline='') as file:
